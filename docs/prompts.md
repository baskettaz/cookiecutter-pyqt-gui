...
- **project_name**: The human-readable name of your project. Used in documentation headings and the README and as envelope to your GUI-Tool. No spaces are allowed.
