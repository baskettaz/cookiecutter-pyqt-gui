...
**Coverage that works the way coverage.py intends.** Branch coverage, parallel mode, Python 3.14 only, and a `fail_under` floor you raise as your project grows. CI collects coverage from every Python version and posts a combined report to the GitHub Actions summary.
